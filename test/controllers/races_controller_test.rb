...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference("Race.count") do
      post races_url, params: { race: { distance: @race.distance, homologated: @race.homologated, location: @race.location, name: @race.name } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { distance: @race.distance, homologated: @race.homologated, location: @race.location, name: @race.name } }
